...
public class LocationService extends Service implements
    ...
    public static final String EXTRA_LONGITUDE = "extra_longitude";    LocationRequest mLocationRequest;
    ...
    public LocationService(Context context, TextView tvGreetingsIn, TextView tvGreetingsOut) {
